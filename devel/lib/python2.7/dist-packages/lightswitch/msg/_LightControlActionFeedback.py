...
"""autogenerated by genpy from lightswitch/LightControlActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class LightControlActionFeedback(genpy.Message):
  _md5sum = "8b16e741187a6a63fdd6923edea755a0"
  _type = "lightswitch/LightControlActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','lightswitch/LightControlFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LightControlActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = lightswitch.msg.LightControlFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = lightswitch.msg.LightControlFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.latency,) = _get_struct_i().unpack(str[start:end])
      return self
