...
let LightControlFeedback = require('./LightControlFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class LightControlActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new LightControlFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LightControlFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LightControlActionFeedback(null);
    ...
    data.feedback = LightControlFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LightControlActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = LightControlFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new LightControlFeedback()
    }
...
module.exports = LightControlActionFeedback;
